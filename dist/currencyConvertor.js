// 30개
export var languageCurrencyMap = {
    'en-US': 'USD', // 미국 - 미국 달러
    'zh-CN': 'CNY', // 중국 - 중국 위안
    'ja-JP': 'JPY', // 일본 - 일본 엔
    'ko-KR': 'KRW', // 한국 - 대한민국 원
...
export default function currencyConvertor(value, options) {
    var w = window;
    if (typeof w !== 'object')
        return '';
    var withSign = options === null || options === void 0 ? void 0 : options.withSign;
    var currency = options === null || options === void 0 ? void 0 : options.currency;
    var signType = options === null || options === void 0 ? void 0 : options.signType;
    var rootLanguage = (options === null || options === void 0 ? void 0 : options.rootLanguage) || 'ko-KR';
    var languages = w.navigator.languages || [rootLanguage];
    var preferenceLanguageAndLocale = languages[0];
    if (!isCurrency(preferenceLanguageAndLocale)) {
        console.error('지원하지 않는 언어입니다.');
    }
    var formatted = Intl.NumberFormat(preferenceLanguageAndLocale, {
        style: 'currency',
        ...
        currency: currency
            ...
            : languageCurrencyMap[preferenceLanguageAndLocale] ||
                (languageCurrencyMap === null || languageCurrencyMap === void 0 ? void 0 : languageCurrencyMap[rootLanguage]),
    }).format(value);
    if (withSign) {
        switch (signType) {
            case 'localized':
    ...
    var matches = formatted.match(/[\d,]+/g);
