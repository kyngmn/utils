export default function formatNetworkErrorMessage(_a) {
    var message = _a.message, customMessage = _a.customMessage, code = _a.code, status = _a.status;
    var formatted = '';
    switch (code) {
    ...
    return (formatted || customMessage || message || '알 수 없는 오류가 발생했습니다.');
}
